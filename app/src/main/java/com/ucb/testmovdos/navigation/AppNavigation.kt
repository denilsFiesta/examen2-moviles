...
import com.ucb.testmovdos.home.HomeCUI
    ...
    NavHost(
        ...
        composable(Screens.Home.route) {
            HomeUI(
                ...
                onGoToLeft = {navController.navigate(Screens.HomeC.route)},
        ...
        composable(Screens.HomeB.route) {
            HomeBUI (
                ...
                onGoToRight = {navController.navigate(Screens.HomeC.route)}
            )
        }

        composable(Screens.HomeC.route) {
            HomeCUI (
                onGoToSend = {navController.navigate(Screens.Send.route)},
                onGoToLeft = {navController.navigate(Screens.HomeB.route)},
